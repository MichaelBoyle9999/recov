...
\author{
Isabel Martín-Fuentes ${ }_{\oplus}{ }^{1 e}$, José M. Oliva-Lozano ${ }^{1 e}$, José M. Muyor® ${ }^{1,2 \circ n}$ * \\ 1 Health Research Centre, University of Almería, Almería, Spain, 2 Laboratory of Kinesiology, Biomechanics and Ergonomics (KIBIOMER Lab.), Research Central Services, University of Almería, Almería, Spain \\ - These authors contributed equally to this work. \\ a Current address: University of Almería, Faculty of Educational Sciences, Almería, (Spain) \\ * josemuyor @ ual.es
}
...
This systematic review was reported and developed following the Preferred Reporting of Systematic Reviews and Meta-Analysis (PRISMA) guidelines [29, 30]. The protocol for this systematic review was registered on PROSPERO (CRD42019138026) and is available in full on
the National Institute for Health Research (https://www.crd.york.ac.uk/prospero/display_ record.php?ID=CRD42019138026). The quality of included studies was assessed by two reviewers using the PEDro quality scale, which consists on eleven questions and distributes the score proportionally to the total amount of questions included. However, due to the inability to blind researchers and trainees, three of eleven questions were excluded from the scale resulting in a maximum of eight [17].
...
Articles were selected by two independent reviewers according to inclusion and exclusion criteria. After eliminating duplicates, the titles and abstracts were analyzed and if there was not
enough information, the full text was evaluated. All studies identified from the database searches were downloaded into the software EndNote version X9 (Clarivate Analytics, New York, NY, USA).
...
No common criteria were followed when referring to the exercise loading at which exercises were evaluated during sEMG recordings. As a matter of fact, only two studies used a similar method, assessing one repetition maximum intensity (1RM) [22,32]. Some studies measured a number of repetitions of xRM, whereas others measured a number of repetitions of a range between $65-85 \%$ of 1 RM (Table 1), which could be considered in all cases as a submaximal load intensity [33].

Data regarding the studies' general description and main findings are presented in Table 1, while Tables $2-5$ contain data referring to muscle activation during Deadlift exercise and/or its variants. We found no unified criteria for the sEMG normalization method. Out of all included studies, seven reported data description regarding muscle activation in relation to exercise type and normalized sEMG activity as a percentage of maximal voluntary isometric contraction (\% MVIC) (Table 2); three of them as percentage of peak root mean square (\% peak RMS) (Table 3); two studies reported data expressed as absolute RMS values in microvolts (mV) (Table 4); and three studies expressed data as a percentage of 1 repetition maximum (\% 1RM) (Table 5). In addition, there were four studies which were not included in the

\begin{figure}
\includegraphics[alt={},max width=\textwidth]{https://cdn.mathpix.com/cropped/73cd66f4-3914-4a2d-ab2f-37ebfe9928b2-05.jpg?height=2111&width=1816&top_left_y=266&top_left_x=191}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 1. Data gathered from selected articles regarding intervention, sample size, gender, training experience, age, sEMG collection method, outcomes and main findings.}
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline Reference & Exercises tested & Sample & Age (years) & Experience (years) & sEMG collection method & Activity sEMG recorded of muscles: & Main findings \\
\hline Krings et al. (2019) [32] & Deadlift versus fat gripz deadlift & 15 Men & $22.4 \pm 2.4$ & Not indicated & 1 rep 1RM & Biceps brachialis, triceps braquialis and forearm muscles & Greater forearm activation and significant decrease in 1RM during fat gripz deadlift \\
\hline \begin{tabular}{l}
Andersen et al. (2019) \\
[8]
\end{tabular} & Deadlift versus FW-2EB and FW-4EB & 15 Men & $23.3 \pm 2.2$ & $3.9 \pm 1.9$ & 2 reps 2RM & Gluteus maximus, vastus lateralis, biceps femoris, semitendinosus and erector spinae & Greater erector spinae activation when more elastic bands added \\
\hline \begin{tabular}{l}
McCurdy et al. (2018) \\
[40]
\end{tabular} & Stiff leg deadlift versus back squat and modified single leg squat & 18 Women & $20.9 \pm 1.1$ & 1-5 years & 3 rep with 8RM & Gluteus maximus and hamstrings & Greater gluteus maximus activation than hamstrings for all exercises. Modified single leg squat elicited the greatest activation \\
\hline Lee et al. (2018) [27] & Deadlift versus Romanian deadlift & 21 Men & $22.4 \pm 2.2$ & > 3 years & 5 rep 70\% of RD 1RM & Gluteus maximus, rectus femoris and biceps femoris & Greater gluteus maximus and rectus femoris activation for deadlift \\
\hline Korak et al. (2018) [39] & Deadlift versus paralell back squat and paralell front squat & 13 Women & $22.8 \pm 3.1$ & > 1 year & 3 reps 75\% 1RM & Gluteus maximus, biceps femoris, vastus medialis, vastus lateralis and rectus femoris & Greater gluteus maximus activation during front and back squat in comparison to deadlift \\
\hline \begin{tabular}{l}
Edington et al. (2018) \\
[35]
\end{tabular} & ISOMETRIC: close-bar deadlift versus far-bar deadlift & 5 men \& 5 women & $32 \pm 10$ & $6.05 \pm 3.35$ & 3 trials in both starting positions. ISOpull & Gluteus maximus, biceps femoris, vastus lateralis, erector spinae and latissimus dorsi & Greater erector spinae and biceps femoris activation than the rest of muscles for both exercises. Greater vastus lateralis activation during far-bar deadlift \\
\hline \begin{tabular}{l}
Andersen et al. (2018) \\
[22]
\end{tabular} & Deadlift versus hexagonal bar deadlift and hip thrust & 13 Men & $21.9 \pm 1.6$ & $4.5 \pm 1.9$ & 1 rep 1RM & Gluteus maximus, biceps femoris and erector spinae & Greater biceps femoris activation during deadlift. Greater gluteus maximus activation during hip thrust. Erector spinae activation showed no differences among exercises \\
\hline Snyder et al. (2017) [36] & Deadlift versus walk-in deadlift machine (2 different feet positions) & 2 women \& 13 men & 18-24 & Not indicated & 3 reps 80\% 3RM & Gluteus maximus, biceps femoris, vastus lateralis and erector spinae & Greater erector spinae activation during deadlift. Greater gluteus maximus and lower vastus lateralis activation during deadlift compared to walk-in machine deadlifts \\
\hline Iversen et al. (2017) [41] & Stiff leg deadlift versus stiff leg deadlift with elastic bands & 17 men \& 12 women & $25 \pm 3$ men $25 \pm 2$ women & Not indicated & 3 reps 10RM & Gluteus maximus, biceps femoris, semitendinosus, vastus medialis, vastus lateralis, rectus femoris, erector spinae and external oblique & Greater activation for all muscles during conventional resistance exercises compared to elastic band deadlifts. Rectus femoris showed no differences activation among exercises \\
\hline Bourne et al. (2017) [16] & Stiff leg deadlift versus unilateral stiff leg deadlift, hip hinge, $45^{\circ}$ hip extension and nordic hamstring exercise & 18/10 Men & $23.9 \pm 3.1$ & Not indicated & 6 reps 12RM & Biceps femoris and semitendinosus & Greater semitendinosus concentric activation during unilateral stiff leg deadlift versus remaining exercises. Similar biceps femoris and semitendinosus activation during both deadlift exercises \\
\hline Nijem et al. (2016) [37] & Deadlift versus deadlift with chains & 13 Men & $24.0 \pm 2.1$ & Not indicated & 3 reps 85\% 1RM & Gluteus maximus, vastus lateralis and erector spinae & Greater gluteus maximus activation during deadlift. Greater erector spinae activation during the beginning of the movement for both exercises \\
\hline
\end{tabular}
\end{table}
(Continued)
...
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline Reference & Exercises tested & Sample & Age (years) & Experience (years) & sEMG collection method & Activity sEMG recorded of muscles: & Main findings \\
\hline Camara et al. (2016) [38] & Deadlift versus hexagonal bar deadlift & 20 Men & $23.3 \pm 2.1$ & > 1 year & 3 reps 65\% 1RM \& 3 reps 85\% 1RM & Biceps femoris, vastus lateralis and erector spinae & Greater vastus lateralis activation; and lower biceps femoris and erector spinae activation during hexagonal bar deadlift \\
\hline \begin{tabular}{l}
Schoenfeld et al. (2015) \\
[42]
\end{tabular} & Stiff leg deadlift versus prone lying leg curl in machine & 10 Men & $23.5 \pm 3.1$ & $4.6 \pm 2.2$ & 1 set 8RM & Biceps femoris and semitendinosus & Greater upper biceps femoris and upper semitendinosus activation during stiff leg deadlift \\
\hline \begin{tabular}{l}
McAllister et al. (2014) \\
[44]
\end{tabular} & Romanian deadlift versus glute ham-raise, good morning and prone leg curl & 12 Men & $27.1 \pm 7.7$ & $8.6 \pm 5.5$ & 85\% 1RM & Gluteus medius, biceps femoris, semitendinosus, erector spinae and medial gastrocnemius & Greater semitendinosus activation than biceps femoris and erector spinae activation for all exercises \\
\hline Bezerra et al. (2013) [26] & Deadlift versus stiff leg deadlift & 14 Men & $26.7 \pm 4.9$ & > 2 years & 3 reps 70\% 1RM & Biceps femoris, vastus lateralis, lumbar multifidus, anterior tibialis and medial gastrocnemius & Greater vastus lateralis activation during deadlift. Greater medial gastrocnemius activation during stiff leg deadlift \\
\hline ChulviMedrano et al. (2010) [28] & Deadlift versus Bosu deadlift and T-Bow device deadlift & 31 & $24.2 \pm 0.4$ & > 1 year & Dinamic effort, 6 reps 70\% of MVIC & Lumbar multifidus, thoracic multifidus, lumbar spinae and thoracic spinae & Greater overall activation during deadlift versus Bosu and T-Bow device deadlifts \\
\hline Ebben (2009) [43] & Stiff leg deadlift versus unilateral stiff leg deadlift, good morning, seated leg curl, nordic hamstring exercise and squat & 21 men \& 13 women & $20.3 \pm 1.7$ & Not indicated & 2 reps 6RM & Rectus femoris and hamstrings & Greater biceps femoris activation during seated leg curl and nordic hamstring than remaining exercises. Greater rectus femoris activation during squat \\
\hline Hamlyn et al. (2007) [34] & Deadlift versus paralell squat & 8 men \& 8 women & $24.1 \pm 6.8$ & Not indicated & 6 reps 80\% 1RM & Lower abdominal, external oblique, lumbar-sacral erector spinae and upper lumbar erector spinae & Greater upper lumbar erector spinae activation during deadlift \\
\hline Escamilla et al. (2002) [13] & Deadlift versus sumo deadlift (both with/ without belt) & 13 Men & $20.1 \pm 1.3$ & Not indicated & 4 reps 12 RM & Gluteus maximus, biceps femoris, vastus medialis, vastus lateralis, rectus femoris, lateral and medial gastrocnemius, tibialis anterior, L3, T12, medial and upper trapezius, rectus abdominis and external oblique & Greater vastus medialis, vastus lateralis and tibialis anterior activation during sumo deadlift. Greater medialis gastrocnemius activation during deadlift. Greater rectus abdominis activation during belt deadlift and belt sumo deadlift \\
\hline
\end{tabular}
\end{table}
...
tables because they assessed the sEMG only from the upper limbs or showed the muscle activation in a different measurement unit than that used in our analysis [28, 32, 34, 35].
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 2. Data description regarding sEMG activity in each study, in relation to exercise type and normalized sEMG activation expressed as mean or peak \% MVIC.}
\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|}
\hline Reference & Exercise & Gluteus Maximus & Biceps Femoris & Semitendinosus & Hamstrings & Vastus Lateralis & Vastus Medialis & Rectus Femoris & Erector Spinae \\
\hline McCurdy et al. (2018) [40] & Stiff leg deadlift & $51.1 \pm 22.1 \%$ mean conc $29.9 \pm 16.2 \%$ mean eccen & n/a & n/a & $39.8 \pm 16.6 \%$ mean conc $19.9 \pm 11.3 \%$ mean eccen & n/a & n/a & n/a & n/a \\
\hline \multirow[t]{2}{*}{Andersen et al. (2018) [22]} & Deadlift & $\sim 95 \%$ mean & ~108\% mean & n/a & n/a & n/a & n/a & n/a & $\sim 86 \%$ mean \\
\hline & Hexagonal bar deadlift (HBDL) & $\sim 88 \%$ mean & $\sim 83 \%$ mean & n/a & n/a & n/a & n/a & n/a & $\sim 82 \%$ mean \\
\hline \multirow[t]{2}{*}{Iversen et al. (2017) [41]} & Stiff leg deadlift & $\sim 42 \%$ peak conc $\sim 17 \%$ peak eccent & ~38\% peak conc $\sim 17 \%$ peak eccent & $\sim 44 \%$ peak conc $\sim 22 \%$ peak eccent & n/a & ~13\% peak conc $\sim 14 \%$ peak eccent & $\sim 10 \%$ peak conc $\sim 9 \%$ peak eccent & $\sim 6 \%$ peak conc $\sim 7 \%$ peak eccent & $\sim 69 \%$ peak conc $\sim 38 \%$ peak eccent \\
\hline & Stiff leg deadlift with elastic bands & $\sim 27 \%$ peak conc ~17\% peak eccent & $\sim 20 \%$ peak conc ~17\% peak eccent & $\sim 23 \%$ peak conc $\sim 21 \%$ peak eccent & n/a & ~12\% peak conc ~14\% peak eccent & $\sim 9 \%$ peak conc ~8\% peak eccent & $\sim 5 \%$ peak conc ~6\% peak eccent & ~57\% peak conc $\sim 36 \%$ peak eccent \\
\hline \multirow[t]{2}{*}{Bourne et al. (2017) [16]} & Stiff leg deadlift & n/a & ~55\% mean conc $\sim 23 \%$ mean eccen & $\sim 50 \%$ mean conc $\sim 18 \%$ mean eccen & n/a & n/a & n/a & n/a & n/a \\
\hline & Unilateral stiff leg deadlift & n/a & ~50\% mean conc ~26\% mean eccen & $\sim 62 \%$ mean conc $\sim 27 \%$ mean eccen & n/a & n/a & n/a & n/a & n/a \\
\hline Schoenfeld et al. (2015) [42] & Stiff leg deadlift & n/a & $\sim 40 \%$ mean lower ~73\% mean upper & $\sim 47 \%$ mean lower ~125\% mean upper & n/a & n/a & n/a & n/a & n/a \\
\hline \multirow[t]{3}{*}{Ebben (2009) [43]} & Stiff leg deadlift & n/a & n/a & n/a & $49 \pm 27 \%$ mean & n/a & n/a & n/a & n/a \\
\hline & Unilateral stiff leg deadlift & n/a & n/a & n/a & $48 \pm 39 \%$ mean & n/a & n/a & n/a & n/a \\
\hline & Good morning & n/a & n/a & n/a & $43 \pm 16 \%$ mean & n/a & n/a & n/a & n/a \\
\hline \multirow[t]{2}{*}{Escamilla et al. (2002) [13]} & Deadlift & $35 \pm 27 \%$ mean & $28 \pm 19 \%$ mean & $27 \pm 23 \%$ mean & n/a & $40 \pm 22 \%$ mean & $36 \pm 25 \%$ mean & $19 \pm 16 \%$ mean & n/a \\
\hline & Sumo deadlift & $37 \pm 28 \%$ mean & $29 \pm 19 \%$ mean & $31 \pm 23 \%$ mean & n/a & $48 \pm 24 \%$ mean & $44 \pm 27 \%$ mean & $18 \pm 13 \%$ mean & n/a \\
\hline
\end{tabular}
\end{table}
...
\section*{Concentric and eccentric phases}
...
The biceps femoris has been the most investigated muscle in terms of sEMG for the Deadlift exercise and its variants (13/19 studies). Gluteus maximus is the next muscle most evaluated

\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 3. Data description regarding sEMG activity in each study, in relation to exercise type and normalized sEMG activation expressed as \% peak RMS.}
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline Reference & Exercise & Gluteus maximus & Biceps Femoris & Vastus Lateralis & Rectus Femoris & Erector Spinae & Lumbar Multifidus \\
\hline \multirow[t]{2}{*}{Lee et al. (2018) [27]} & Deadlift & $51.52 \pm 6.0$ peak RMS & $57.45 \pm 6.34 \%$ peak RMS & n/a & $58.57 \pm 13.73 \%$ peak RMS & n/a & n/a \\
\hline & Romanian deadlift & $46.88 \pm 7.39 \%$ peak RMS & $56.66 \pm 18.56 \%$ peak RMS & n/a & $25.26 \pm 14.21 \%$ peak RMS & n/a & n/a \\
\hline \multirow[t]{3}{*}{Snyder et al. (2017) [36]} & Deadlift & $\sim 47 \%$ peak RMS & $\sim 28 \%$ peak RMS & $\sim 48 \%$ peak RMS & n/a & $\sim 73 \%$ peak RMS & n/a \\
\hline & BallPro & $\sim 30 \%$ peak RMS & $\sim 25 \%$ peak RMS & $\sim 80 \%$ peak RMS & n/a & ~53\% peak RMS & n/a \\
\hline & ToePro & $\sim 30 \%$ peak RMS & $\sim 31 \%$ peak RMS & ~63\% peak RMS & n/a & ~58\% peak RMS & n/a \\
\hline \multirow[t]{2}{*}{Bezerra et al. (2013) [26]} & Deadlift & n/a & $100.1 \pm 24.7 \%$ peak RMS & $128.3 \pm 33.9 \%$ peak RMS & n/a & n/a & $112.7 \pm 42.7 \%$ peak RMS \\
\hline & Stiff leg deadlift & n/a & $98.6 \pm 28.5 \%$ peak RMS & $101.1 \pm 14.6 \%$ peak RMS & n/a & n/a & $106 \pm 20.5 \%$ peak RMS \\
\hline
\end{tabular}
\end{table}
...
(10/19) followed by vastus lateralis and erector spinae muscles (9/19). The semitendinosus and rectus femoris are positioned in fourth position (5/19) followed by vastus medialis, external oblique and medial gastrocnemius (3/19) (Table 1).
...
Studies in which muscle activation was expressed as a mean or peak \% MVIC are shown in Table 2. Erector spinae showed the greatest muscle activation during the Stiff Leg Deadlift exercise [41], and also showed a similar muscle activation than the gluteus maximus or biceps femoris during Deadlift and Hexagonal Bar Deadlift exercises [22]. Except for the Deadlift exercise [22], the gluteus maximus showed greater muscle activation than biceps femoris [13,

\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 4. Data description regarding sEMG activity in each study, in relation to exercise type and normalized sEMG activation expressed as absolute RMS values in mV.}
\begin{tabular}{|l|l|l|l|l|l|l|}
\hline Reference & Exercise & Gluteus maximus & Biceps Femoris & Semitendinosus & Vastus Lateralis & Erector Spinae \\
\hline \multirow[t]{3}{*}{Andersen et al. (2019) [8]} & Deadlift & 236 RMS (mV) & 312 RMS (mV) & 367 RMS (mV) & 239 RMS (mV) & 341 RMS (mV) \\
\hline & DL FW-2EB & 231 RMS (mV) & 313 RMS (mV) & 359 RMS (mV) & 234 RMS (mV) & 330 RMS (mV) \\
\hline & DL FW-4EB & 250 RMS (mV) & 326 RMS (mV) & 375 RMS (mV) & 238 RMS (mV) & 357 RMS (mV) \\
\hline \multirow[t]{4}{*}{McAllister et al. (2014) [44]} & Romanian deadlift & n/a & $\sim 360$ RMS (mV) conc $\sim 300$ RMS (mV) eccen & $\sim 810$ RMS (mV) conc $\sim 790$ RMS (mV) eccen & n/a & $\sim 210$ RMS (mV) conc \\
\hline & Glute hamraise & n/a & $\sim 380$ RMS (mV) conc $\sim 160$ RMS (mV) eccen & $\sim 1180$ RMS (mV) conc $\sim 490$ RMS (mV) eccen & n/a & $\sim 430$ RMS (mV) conc \\
\hline & Good morning & n/a & $\sim 290$ RMS (mV) conc $\sim 210$ RMS (mV) eccen & $\sim 910$ RMS (mV) conc $\sim 590$ RMS (mV) eccen & n/a & $\sim 205$ RMS (mV) conc \\
\hline & Prone leg curl & n/a & $\sim 240$ RMS (mV) conc $\sim 85$ RMS (mV) eccen & $\sim 870$ RMS (mV) conc $\sim 330$ RMS (mV) eccen & n/a & $\sim 255$ RMS (mV) conc \\
\hline
\end{tabular}
\end{table}
...
\begin{table}
\captionsetup{labelformat=empty}
\caption{Table 5. Data description regarding muscle activation in mV expressed as a percentage of EMG (mV) during 1RM effort.}
\begin{tabular}{|l|l|l|l|l|l|l|l|}
\hline Reference & Exercise & Gluteus maximus & Biceps Femoris & Vastus Lateralis & Vastus Medialis & Rectus Femoris & Erector Spinae \\
\hline \multirow[t]{3}{*}{Korak et al. (2018) [39]} & Deadlift & 72\% 1RM & 82\% 1RM & 104\% 1RM & 92\%1RM & 105\%1RM & n/a \\
\hline & Parallel back squat & 80\% 1RM & 78\% 1RM & 97\% 1RM & 96\%1RM & 102\%1RM & n/a \\
\hline & Parallel front squat & 94\% 1RM & 81\% 1RM & 102\% 1RM & 98\%1RM & 101\%1RM & n/a \\
\hline \multirow[t]{2}{*}{Nijem et al. (2016) [37]} & Deadlift & $82.5 \pm 6.9 \%$ 1RM & n/a & $115.9 \pm 30.1 \% 1 \mathrm{RM}$ & n/a & n/a & $97.9 \pm 8.7 \% 1 \mathrm{RM}$ \\
\hline & Deadlift with chains & $76.8 \pm 6.8 \%$ 1RM & n/a & $123.3 \pm 45.1 \% 1 \mathrm{RM}$ & n/a & n/a & $93.2 \pm 11 \% 1 \mathrm{RM}$ \\
\hline \multirow[t]{2}{*}{Camara et al. (2016) [38]} & Deadlift & n/a & \begin{tabular}{l}
$83.5 \pm 19 \% 1 \mathrm{RM}$ conc \\
$34.7 \pm 11 \% 1 \mathrm{RM}$ eccen
\end{tabular} & \begin{tabular}{l}
$96.8 \pm 22 \% 1 \mathrm{RM}$ conc \\
$55.9 \pm 12.6 \% 1 \mathrm{RM}$ eccen
\end{tabular} & n/a & n/a & \begin{tabular}{l}
$98.9 \pm 26 \% 1 \mathrm{RM}$ conc \\
$75.3 \pm 28 \% 1$ RM eccen
\end{tabular} \\
\hline & Hexagonal bar deadlift & n/a & \begin{tabular}{l}
$72.3 \pm 20 \% 1 \mathrm{RM}$ conc \\
$31.5 \pm 10 \% 1 \mathrm{RM}$ eccen
\end{tabular} & \begin{tabular}{l}
$119.9 \pm 22 \% 1 \mathrm{RM}$ conc \\
$87.9 \pm 31 \% 1 \mathrm{RM}$ eccen
\end{tabular} & n/a & n/a & \begin{tabular}{l}
$88 \pm 27 \% 1 \mathrm{RM}$ conc \\
$61.4 \pm 21 \% 1$ RM eccen
\end{tabular} \\
\hline
\end{tabular}
\end{table}
...
22, 40, 41]. When comparing muscle activation within the hamstrings, there was a greater activation for the semitendinosus muscle than the biceps femoris during Stiff Leg Deadlift [16, 41, 42], which is even more pronounced when performing Unilateral Stiff Leg Deadlift [16]. The concentric phase showed a greater activation in the gluteus maximus and hamstring muscles than the eccentric phase for all exercises evaluated [16, 40, 41] (Table 2).
...
In regard to interelectrode distance, five studies reported using the recommended 2 cm center-to-center distance between electrodes according to SENIAM Guidelines [8, 22, 27, 35, 43]. In addition to not following these Guidelines, some other studies also did not report the inter-electrode distance [26,32,34,38-40,44]. Furthermore, four studies reported to have placed the electrodes with a center-to-center distance ranging between $15-35 \mathrm{~mm}$ but different from 20 mm [13,16,28,37,41]. The higher the interelectrode distance, the wider the detection volume and consequently the detected amplitude [55]. Future research should attempt to follow established Guidelines, so they can reach optimum research quality and diminish the risk of data collection bias.
...
In order to avoid fatigue bias risks, a randomized counterbalanced order for exercise testing was followed in all studies but one, which followed a preset exercise order [41]. In addition with the same aim, a minimum break of $2-5 \mathrm{~min}$ was considered between exercise testing trials [22, 27, 28, 34, 36, 37, 40-42, 44].
...
\section*{Other Deadlift variations}
...
\section*{Comparing Deadlift to other exercises}
...
3. Taking into consideration the different muscle activation pattern reported during concentric and eccentric exercises phases, it is highly recommended to perform such subdivision for future studies.
...
Conceptualization: Isabel Martín-Fuentes, José M. Oliva-Lozano, José M. Muyor.
Data curation: Isabel Martín-Fuentes, José M. Oliva-Lozano, José M. Muyor.
Formal analysis: Isabel Martín-Fuentes, José M. Muyor.
Funding acquisition: José M. Muyor.
Investigation: Isabel Martín-Fuentes.
Methodology: Isabel Martín-Fuentes, José M. Oliva-Lozano, José M. Muyor.
Supervision: José M. Muyor.
Writing - original draft: Isabel Martín-Fuentes.
Writing - review \& editing: Isabel Martín-Fuentes, José M. Oliva-Lozano, José M. Muyor.
...
16. Bourne MN, Williams MD, Opar DA, AI Najjar A, Kerr GK, Shield AJ. Impact of exercise selection on hamstring muscle activation. Br J Sports Med. 2017; 51(1021-8. https://doi.org/10.1136/bjsports-2015-095739 PMID: 27467123
...
28. Chulvi-Medrano I, García-Massó X, Colado JC, Pablos C, de Moraes JA, Fuster MA. Deadlift muscle force and activation under stable and unstable conditions. J Strength Cond Res. 2010; 24(10): 272330. https://doi.org/10.1519/JSC.0b013e3181f0a8b9 PMID: 20885194
29. Urrútia G , Bonfill X . Declaración PRISMA: una propuesta para mejorar la publicación de revisiones sistemáticas y metaanálisis. Med Clin. 2010; 135(11): 507-11. https://doi.org/10.1016/j.medcli.2010.01. 015 PMID: 20206945
...
47. Komi PV, Linnamo V, Silventoinen P, SillanpÄÄ M. Force and EMG power spectrum during eccentric and concentric actions. Med Sci Sports Exerc. 2000; 32(10): 1757-62. https://doi.org/10.1097/ 00005768-200010000-00015 PMID: 11039649
