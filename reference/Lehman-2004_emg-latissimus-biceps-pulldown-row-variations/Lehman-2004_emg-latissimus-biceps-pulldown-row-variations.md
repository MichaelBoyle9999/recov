...
citation: "Lehman GJ, Buchan DD, Lundy A, Myers N, Nalborczyk A. Variations in muscle activation levels during traditional latissimus dorsi weight training exercises: An experimental study. Dynamic Medicine 2004, 3:4."
doi: "10.1186/1476-5918-3-4"
themes: ["EMG", "latissimus dorsi", "biceps brachii", "strength training", "shoulder exercise"]
source_pdf: "pdfs/Lehman-2004_emg-latissimus-biceps-pulldown-row-variations/Lehman-2004_emg-latissimus-biceps-pulldown-row-variations.pdf"
conversion: "ensemble (olmOCR + MinerU + Docling + Mathpix) aggregated against page images"
conversion_notes: "Paper contains no figures; the only display object is Table 1. MinerU's single cropped image (990595a8...jpg) is a crop of Table 1, not a figure, so it was NOT carried into images/ (images/ is empty). Table 1 transcribed verbatim from page-003.png, including superscript column markers and the '-' placeholders in the 'Diff From' rows. Reference numbering 1-5 is continuous (no skips); some drafts OCR'd the leading '1' of refs as a Roman 'I' (Mathpix), corrected against the page image."
---
...
Gregory J Lehman\*<sup>1</sup>, Day Deans Buchan<sup>2</sup>, Angela Lundy<sup>2</sup>, Nicole Myers<sup>2</sup> and Andrea Nalborczyk<sup>2</sup>

Address: <sup>1</sup>Department of Graduate Studies, Canadian Memorial Chiropractic College, Toronto, ON, Canada and <sup>2</sup>Undergraduate Department, Canadian Memorial Chiropractic College, Toronto, ON, Canada
...
| Muscle | Pulldown<sup>1</sup> | Reverse<sup>2</sup> | Slack SR<sup>3</sup> | Retract SR<sup>4</sup> |
|---|---|---|---|---|
...
<!-- The four data columns sit under a single spanning header "Exercise Performed" on the page; the column subheads are Pulldown¹, Reverse², Slack SR³, Retract SR⁴. -->
