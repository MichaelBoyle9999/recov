---
title: "Effects of Varying Load Intensity on Skeletal Muscle Damage Between Two Isovolumic Resistance Exercise Bouts"
authors: "Lee J. Winchester, Cody E. Morris, Patton Allen, Teresa L. Wiczynski, Scott W. Arnett, and T. Scott Lyons"
year: 2022
journal: "International Journal of Exercise Science"
citation: "Winchester LJ, Morris CE, Allen P, Wiczynski TL, Arnett SW, Lyons TS. Effects of Varying Load Intensity on Skeletal Muscle Damage Between Two Isovolumic Resistance Exercise Bouts. Int J Exerc Sci 15(4): 1212-1221, 2022."
themes: ["resistance training", "hypertrophy", "muscle damage", "inflammation", "myoglobin"]
source_pdf: "pdfs/Winchester-2022_load-intensity-muscle-damage-isovolumic/Winchester-2022_load-intensity-muscle-damage-isovolumic.pdf"
conversion: "ensemble (olmOCR + MinerU + Docling + Mathpix) aggregated against page images"
conversion_notes: "Author affiliation symbols verified against page 1 image (Winchester‡1, Morris‡2, Allen*3, Wiczynski†3, Arnett‡3, Lyons‡4); olmOCR drafted some of these incorrectly. Figure 1 is a flowchart with an embedded protocol table; both the flowchart crop and the table are reproduced. Figure 2 has two panels (a: Myoglobin, b: CRP), carried as separate crops. The exclusion-criteria citation is printed as '[26]' in the text body — transcribed as printed even though the reference list ends at 24."
---
...
¹Department of Kinesiology, University of Alabama, Tuscaloosa, AL, USA; ²Department of Human Studies, University of Alabama-Birmingham, Birmingham, AL, USA; ³School of Kinesiology, Recreation & Sport, Western Kentucky University, Bowling Green, KY, USA; ⁴Department of Kinesiology, University of North Alabama, Florence, AL, USA
...
Plasma Myoglobin and CRP: For this study, the main outcome variables were assessment of plasma myoglobin and CRP across the three time points as indicators of exercise induced muscular damage and inflammation, respectively (Figure 2). A one-way repeated measures-ANOVA demonstrated that a significant change between groups was observed (p = 0.015; η² = 0.647). Plasma myoglobin protein expression was significantly increased from baseline values after the HHL trial (p = .031), but was not significantly increased after the LHL trial, though it was approaching significance (p = .054; η² = 0.647) (BASE: 1.42±.12 ng/mL; LHL: 4.65±1.13 ng/mL; HHL: 5.00±1.01 ng/mL; F = 7.340). However, there was no significant difference between LHL and HHL for myoglobin (p > 0.995). For CRP, no significant differences (p = 0.74; η² = 0.073) were detected between time points (BASE: 346.93±58.67 pg/mL; LHL: 466.60±173.05 pg/mL; HHL: 320.90±62.66 pg/mL; F = 0.313).
...
Performance: Although the protocol was designed to be volume similar based on standardized training guidelines, there was a significant difference (p ≤ .001; t = -15.150; Cohen's d = 0.165) in mean total volume-load between the two trials (Figure 3). Using the training load calculated from the aforementioned protocol, participants lifted a mean of 7,084.1±515.21 pounds in total during the LHL trial, and 6,807.7±515.60 pounds during the HHL trial.

![Figure 3](images/figure-3.jpg)

> **[Figure 3]** Total Weight Lifted. Mean total weight lifted for LHL and HHL. # indicates significant difference from other trial (p< 0.05). Bar graph data represents mean value ± SEM.
